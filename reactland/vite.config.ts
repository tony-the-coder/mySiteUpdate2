...
import react from '@vitejs/plugin-react' // Using @vitejs/plugin-react as specified
    ...
    build: {
      ...
      rollupOptions: {
        input: {
          ...
          homeHeroEntry: path.resolve(__dirname, "src", "homeHeroEntry.tsx"), //
          certificatesEntry: path.resolve(__dirname, "src", "certificatesEntry.tsx"), // ADDED: New entry for certificates
        }
      }
    }
  }
