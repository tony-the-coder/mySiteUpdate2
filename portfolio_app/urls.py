...
urlpatterns = [
    ...
    path(
        "contact/", views.contact_us, name="contact_us"
    ),  # Page to host your React contact form
    path(
        "simple-react-test/", views.simple_react_test_view, name="simple_react_test"
    ),  # New Test URL
    ...
    path(
        ...
        views.api_portfolio_projects,
        name="api_portfolio_projects",
    ),
    path(
        "api/portfolio-categories/",
        views.api_portfolio_categories,
        name="api_portfolio_categories",
    ),
    path(
        "api/contact-submit/", views.api_contact_submit, name="api_contact_submit"
    ),  # For React contact form
    # --- Staff Portal URLs ---
    path(
        "staff/", views.staff_dashboard, name="staff_dashboard"
    ),  # For your admin/content management
    path("staff/profile/", views.staff_user_profile, name="staff_user_profile"),
    path(
        "staff/profile/edit/",
        views.staff_user_profile_edit,
        name="staff_user_profile_edit",
    ),
    # Staff Portfolio Project Management (for your Coding Projects)
    path(
        "staff/coding-projects/",
        views.staff_portfolio_list,
        name="staff_portfolio_list",
    ),
    path(
        "staff/coding-projects/add/",
        views.staff_portfolio_add,
        name="staff_portfolio_add",
    ),
    path(
        "staff/coding-projects/<int:pk>/edit/",
        views.staff_portfolio_edit,
        name="staff_portfolio_edit",
    ),
    path(
        "staff/coding-projects/<int:pk>/detail/",
        views.portfolio_project_detail_staff,
        name="portfolio_project_detail_staff",
    ),
    path(
        "staff/coding-projects/<int:pk>/delete/",
        views.staff_portfolio_delete,
        name="staff_portfolio_delete",
    ),
    path(
        "staff/coding-projects/<int:pk>/manage-images/",
        views.staff_manage_portfolio_images,
        name="staff_manage_portfolio_images",
    ),
    path(
        "react-minimal-test/", views.react_test_minimal_view, name="react_test_minimal"
    ),
